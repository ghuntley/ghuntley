...
depot.nix.lazy-deps {
  ...
  # shell aliases
  backup.attr = "tools.shell-alias-backup";
  clip.attr = "tools.shell-alias-clip";
  deploy-buildkite.attr = "tools.shell-alias-deploy-buildkite";
  deploy-dns.attr = "tools.shell-alias-deploy-dns";
  deploy-home.attr = "tools.shell-alias-deploy-home";
  deploy-keycloak-ponderoos.attr = "tools.shell-alias-deploy-keycloak-ponderoos";
  deploy-nixos.attr = "tools.shell-alias-deploy-nixos";
  lg.attr = "tools.shell-alias-lg";
  tmux-upterm.attr = "tools.shell-alias-tmux-upterm";
  ...
  # hut
  hut.attr = "third_party.nixpkgs.hut";
  ...
  upterm.attr = "third_party.nixpkgs.upterm";
  ...
  ## go
  go.attr = "third_party.nixpkgs.go_1_23";
